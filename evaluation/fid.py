...
folder_1 = r"F:\Datasets\DigestPath\scene_generation\all\1000\256\split\train\benign_images"
folder_2 = r"F:\Datasets\DigestPath\scene_generation\all\1000\256\split\train\diffusion\benign\images_1"
scale = 0
size = 256
max_file_num = 971

print("computing against ",folder_2)

paths1 = [file for file in os.listdir(folder_1) if file.endswith('.png')]
paths2 = [file for file in os.listdir(folder_2) if file.endswith('.jpg')]
