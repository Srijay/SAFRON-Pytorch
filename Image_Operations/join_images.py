...
parser.add_argument("--patches_dir", help="path to generated patches to join",
                    default=r"F:\Datasets\himico\test\output_train\images")
parser.add_argument("--output_file", help="path to output file",
                    default=r"F:\Datasets\himico\test\output_train\images\sample_test.jpeg")
parser.add_argument("--im_height", default=728, type=int, help="image height")
parser.add_argument("--im_width", default=728, type=int, help="image width")
