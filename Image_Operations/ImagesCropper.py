...
folder_path = r"F:\Datasets\himico\test\B-2032566_B5_HE\ruqayya_patches_2\cycleGAN\himico_tumor"
masks_input_folder = os.path.join(folder_path, "test_A")
images_input_folder = os.path.join(folder_path, "test_B")

output_dir = r"F:\Datasets\himico\test\B-2032566_B5_HE\ruqayya_patches_2\cycleGAN\himico_tumor\cropped\1024"
masks_output_folder = os.path.join(output_dir, "test_A")
images_output_folder = os.path.join(output_dir, "test_B")
